...
#################################
    def menuPersonaje2():
        ...
        etiqueta=tkinter.Label(vtnPersonaje2,
                               text="Escribe las el numero de la cantidad de habilidades\nque le quieres aguerar a tu personaje\nEl total de esats debe ser igual a -100-",
